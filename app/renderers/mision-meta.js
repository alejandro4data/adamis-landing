(() => {
  ...
  function ensureStyles() {
    ...
    style.textContent = `
      ...
      @media(max-width:840px){.mission-meta__shell{display:block;padding:16px 13px 26px}.mission-meta__header{grid-template-columns:1fr;align-items:start}.mission-meta__goals{justify-content:flex-start;margin-top:9px}.mission-meta__stage{margin-top:15px}.mission-meta__content{grid-template-columns:1fr;height:auto}.mission-meta__visual{height:clamp(210px,30vh,300px)}.mission-meta__panel{margin-top:13px}.mission-meta__balances{grid-template-columns:minmax(0,3fr) minmax(180px,2fr)}.mission-meta__complete-wrap{min-height:480px}}
